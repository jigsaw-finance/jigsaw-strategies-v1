 ...
 */
contract SwellV3Strategy is IStrategy, StrategyBaseUpgradeable {
    ...
    struct InitializerParams {
        ...
        address swellVault; // The address of the Swell Vault
        ...
        address tokenOut; // The address of the Swell receipt token (iToken)
    }
 ...
 * @notice Struct containing parameters for a withdrawal operation.
    ...
    /**
     * @notice Emitted when the Swell Vault address is updated.
     * @param _old The old Swell Vault address.
     * @param _new The new Swell Vault address.
     */
    event swellVaultUpdated(address indexed _old, address indexed _new);
    ...
    /**
     * @notice The Swell Vault contract.
     */
    ISwellVault public swellVault;
    ...
    function initialize(InitializerParams memory _params) public initializer {
        ...
        require(_params.swellVault != address(0), "3036");
        ...
        swellVault = ISwellVault(_params.swellVault);
        ...
        receiptToken = IReceiptToken(
            StrategyConfigLib.configStrategy({
                ...
                _receiptTokenName: "Swell Strategy Receipt Token",
                _receiptTokenSymbol: "WBTC"
            })
        );
    ...
    function deposit(
        ...
        OperationsLib.safeApprove({token: _asset, to: address(swellVault), value: _amount});
        swellVault.deposit({assets: _amount, receiver: _recipient});
...
//        require(success, OperationsLib.getRevertMsg(returnData));
    ...
    /**
     * @notice Claims rewards from the Swell Vault.
     *
