...
contract AaveStablecoin is IStrategy, StrategyBase {
    ...
    /**
     * @notice Emitted when the Incentives Controller address is updated.
     * @param _old The old Incentives Controller address.
     * @param _new The new Incentives Controller address.
     */
     ...
     * @param _incentivesController The address of the Aave Incentives Controller.
    ...
    function claimRewards(
        ...
        (tempData.success, tempData.returnData) = IHolding(_recipient).genericCall({
            _contract: address(incentivesController),
    ...
    /**
     * @notice Sets a new Incentives Controller address.
     * @param _newAddr The new Incentives Controller address.
     */
    ...
    function getRewards(address _recipient) external view override onlyValidAddress(_recipient) returns (uint256) {
        address[] memory tokens = new address[](1);
        tokens[0] = tokenOut;
        return incentivesController.getRewardsBalance(tokens, _recipient);
    }
